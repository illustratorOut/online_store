...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        product_list = [
            {'name': 'Помидор', 'description': 'Красный какой-то текст для заполнения контента',
             'category': category[1], 'price': 20,
            ...
            {'name': 'Черешня',
             'description': 'Древесное растение, принадлежащее к деревьям первой величины. Характеризуется быстрым ростом, особенно в молодом возрасте. ',
             'category': category[2], 'price': 5300},
